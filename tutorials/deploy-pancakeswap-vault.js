...
import stratAbi from "../artifacts/contracts/PRFCT/strategies/Common/StrategyCommonChefLP.sol/StrategyCommonChefLP.json";

const {
  platforms: { pancake, prfctfinance },
  tokens: {
...
const strategyParams = {
  ...
  keeper: prfctfinance.keeper, // Pulled from address book automatically
  prfctFeeRecipient: prfctfinance.prfctFeeRecipient, // Pulled from address book automatically
  prfctFeeConfig: prfctfinance.prfctFeeConfig, // Pulled from address book automatically
  prfctVaultProxy: prfctfinance.vaultFactory, // Pulled from the address book automatically
};
