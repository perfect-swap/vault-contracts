...
contract PrfctFeeBatchV2 is Initializable, OwnableUpgradeable {
    ...
    function initialize(
        ...
        wNativeToPrfctRoute = [_wNative, _prfct];
    }
    ...
    function harvest() public {
        ...
        if (routerInitialized) {
            ...
            IUniswapRouter(unirouter).swapExactTokensForTokens(treasuryHalf, 0, wNativeToPrfctRoute, treasury, block.timestamp);
        } else {
    ...
    function setNativeToPrfctRoute(address[] memory _route) external onlyOwner {
