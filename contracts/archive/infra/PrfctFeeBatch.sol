...
contract PrfctFeeBatch is Ownable {
    ...
    constructor(
        ...
        wNativeToPrfctRoute = [wNative, prfct];
    ...
    function harvest() public {
        ...
        IUniswapRouterETH(unirouter).swapExactTokensForTokens(treasuryHalf, 0, wNativeToPrfctRoute, treasury, now);
    ...
    function setNativeToPrfctRoute(address[] memory _route) external onlyOwner {
        ...
        require(_route[_route.length - 1] == prfct);
