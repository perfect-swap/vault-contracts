...
contract StrategyBake is Ownable, Pausable {
     ...
     *
     * {REWARDS_FEE} - 3.5% goes to PRFCT holders through the {rewards} pool.
    ...
    function chargeFees() internal {
        ...
        IBakerySwapRouter(unirouter).swapExactTokensForTokens(treasuryHalf, 0, wbnbToPrfctRoute, treasury, now.add(600));
