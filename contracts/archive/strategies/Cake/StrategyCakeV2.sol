...
contract StrategyCakeV2 is StratManagerCake, FeeManagerCake {
    ...
    ) StratManagerCake(_keeper, _unirouter, _vault, _prfctFeeRecipient) public {
        _giveAllowances();
    }
    ...
    function chargeFees() internal {
        ...
        uint256 prfctFeeAmount = wrappedBal.mul(prfctFee).div(MAX_FEE);
        IERC20(wrapped).safeTransfer(prfctFeeRecipient, prfctFeeAmount);
    }
