...
contract StrategyHyperLP is Ownable, Pausable {
     ...
     *
     * {REWARDS_FEE} - 2% goes to PRFCT holders through the {rewards} pool.
    ...
    function chargeFees() internal {
        ...
        IThugswapRouter(unirouter).swapExactTokensForTokens(treasuryHalf, 0, wbnbToPrfctRoute, treasury, now.add(600));
