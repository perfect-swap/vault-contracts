...
import { IPrfctOracle } from "../../interfaces/oracle/IPrfctOracle.sol";
import { PrfctOracleErrors } from "./PrfctOracleErrors.sol";

/// @title Prfct Oracle Helper
/// @author Prfct, @kexley
/// @notice Helper functions for Prfct oracles
library PrfctOracleHelper {
    ...
    /// @param _oracle Central Prfct oracle which stores the base token price
    ...
    function priceFromBaseToken(
        ...
        (uint256 basePrice,) = IPrfctOracle(_oracle).getFreshPrice(_baseToken);
