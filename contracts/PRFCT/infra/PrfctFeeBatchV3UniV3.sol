...
contract PrfctFeeBatchV3UniV3 is Initializable, OwnableUpgradeable {
    ...
    bytes public wNativeToPrfctRoute;
    ...
    event NewPrfctRoute(bytes oldRoute, bytes newRoute);
    ...
    function harvest() public {
        ...
        if (splitTreasury) {
            ...
            prfctOut = UniV3Actions.swapV3WithDeadline(unirouter, wNativeToPrfctRoute, prfctAmt, treasury);
        } else {
        ...
        emit Harvest(wNativeBal, stableOut, prfctOut, rewardPoolAmount, block.timestamp);
    }
