...
contract StrategyAuraBalancerComposableMultiRewardGaugeUniV3 is StrategyFeeManagerInitializable {
    ...
    PrfctBalancerStructs.BatchSwapStruct[] public nativeToWantRoute;
    ...
    function initialize(
        PrfctBalancerStructs.BatchSwapStruct[] memory _nativeToWantRoute,
    ...
    function addLiquidity() internal {
        uint256 nativeBal = IERC20(native).balanceOf(address(this));
        IBalancerVault.BatchSwapStep[] memory _swaps = BalancerOrigActionsLib.buildSwapStructArray(nativeToWantRoute, nativeBal);
        BalancerOrigActionsLib.balancerSwap(unirouter, swapKind, _swaps, nativeToWantAssets, funds, int256(nativeBal));
    }
