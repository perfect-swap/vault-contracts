...
contract StrategyBalancerComposableMultiRewardGaugeUniV3 is StrategyFeeManagerInitializable {
    ...
    function initialize(
        address _want,
        PrfctBalancerStructs.BatchSwapStruct[] calldata _nativeToWantRoute,
