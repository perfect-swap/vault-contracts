...
/**
 * @dev Interface of a Prfct Vault
 */
interface IVault {
...
/**
 * @title Prfct Wrapper ERC-4626
 * @author kexley
 * @notice Implementation for an ERC-4626 wrapper of a Prfct Vault
 * @dev Wrapped Prfct Vault tokens can be minted by deposit of the underlying asset or by 
 * wrapping Prfct Vault tokens in a 1:1 ratio. Wrapped Prfct Vault tokens can either be unwrapped
 * for an equal number of Prfct Vault tokens or redeemed for the underlying asset
 */
contract PrfctWrapper is ERC4626Upgradeable {
    ...
    /**
     * @notice Initializes an ERC-4626 wrapper for a Prfct Vault token
