...
import { PrfctHarvester, PrfctUniV2Zap, PrfctRegistry, IUniswapRouterETH, IWrappedNative, StrategyCommonChefLP, UpkeepRefunder } from "../../typechain-types";
...
const { prfctfinance } = chainData.platforms;
...
describe("PrfctHarvester", () => {
  let harvester: PrfctHarvester;
  let vaultRegistry: PrfctRegistry;
  let zap: PrfctUniV2Zap;
