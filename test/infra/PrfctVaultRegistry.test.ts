...
import { PrfctVaultRegistry } from "../../typechain-types";
...
describe("PrfctVaultRegistry", () => {
  let registry: PrfctVaultRegistry;
  ...
  beforeEach(async () => {
    ...
    )) as unknown as PrfctVaultRegistry;
  });
