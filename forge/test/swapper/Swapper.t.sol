...
import { UniswapV3Utils, IUniswapRouterV3WithDeadline } from "../../../contracts/PRFCT/utils/UniswapV3Utils.sol";
import { IUniswapRouterETH } from "../../../contracts/PRFCT/interfaces/common/IUniswapRouterETH.sol";
import { ISolidlyRouter } from "../../../contracts/PRFCT/interfaces/common/ISolidlyRouter.sol";
import { IBalancerVault } from "../../../contracts/PRFCT/interfaces/beethovenx/IBalancerVault.sol";

// Interfaces
import { IERC20 } from "@openzeppelin-4/contracts/token/ERC20/IERC20.sol";
import { PrfctSwapper } from "../../../contracts/PRFCT/infra/PrfctSwapper.sol";
import { PrfctOracle } from "../../../contracts/PRFCT/infra/PrfctOracle/PrfctOracle.sol";
import { PrfctOracleChainlink } from "../../../contracts/PRFCT/infra/PrfctOracle/PrfctOracleChainlink.sol";

contract Swapper is Test {

    PrfctSwapper public swapper;
    PrfctOracle public oracle;
    ...
    function setUp() public {
        oracle = new PrfctOracle();
        oracle.initialize();

        swapper = new PrfctSwapper();
        swapper.initialize(address(oracle), 0.99 ether);

        address chainlinkOracle = deployCode("PrfctOracleChainlink.sol");
        ...
        address solidlyOracle = deployCode("PrfctOracleSolidly.sol");
    ...
    function testSetSwapInfo() external {
        ...
        swapper.setSwapInfo(
            ...
            PrfctSwapper.SwapInfo(uniswapV3Router, data, amountIndex, minIndex, minSign)
        );
    ...
    function testSetSwapInfoUniswapV2() external {
        ...
        swapper.setSwapInfo(
            route[0],
            route[route.length - 1],
            PrfctSwapper.SwapInfo(uniswapV2Router, data, amountIndex, minIndex, minSign)
        );
    ...
    function testSetSwapInfoSolidly() external {
        ...
        swapper.setSwapInfo(
            route[0],
            route[route.length - 1],
            PrfctSwapper.SwapInfo(solidlyRouter, data, amountIndex, minIndex, minSign)
        );
    ...
    function testSetSwapInfoBalancer() external {
        ...
        swapper.setSwapInfo(
            ...
            PrfctSwapper.SwapInfo(balancerRouter, data, amountIndex, minIndex, minSign)
        );
