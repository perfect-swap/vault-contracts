...
interface IStrategy {
    ...
    function prfctFee() external view returns (uint256);

    function prfctFeeRecipient() external view returns (address);

    function prfctFeeConfig() external view returns (address);
    ...
    function setPrfctFeeRecipient(address _prfctFeeRecipient) external;
