...
import { IUniswapV2Pair } from "../../../contracts/PRFCT/interfaces/common/IUniswapV2Pair.sol";
...
import { PrfctOracleUniswapV3 } from "../../../contracts/PRFCT/infra/PrfctOracle/PrfctOracleUniswapV3.sol";
import { PrfctOracleUniswapV2 } from "../../../contracts/PRFCT/infra/PrfctOracle/PrfctOracleUniswapV2.sol";
import { PrfctOracleSolidly } from "../../../contracts/PRFCT/infra/PrfctOracle/PrfctOracleSolidly.sol";
import { PrfctOracleErrors } from "../../../contracts/PRFCT/infra/PrfctOracle/PrfctOracleErrors.sol";
...
contract Oracle is Test {
    ...
    function testSetUniswapV3Oracle() external {
        ...
        address uniswapV3Oracle = deployCode("PrfctOracleUniswapV3.sol");
    ...
    function testSetUniswapV2Oracle() external {
        ...
        address uniswapV2Oracle = deployCode("PrfctOracleUniswapV2.sol");
    ...
    function testSetOracleNoBasePrice() external {
        ...
        address uniswapV3Oracle = deployCode("PrfctOracleUniswapV3.sol");
        vm.expectRevert(abi.encodeWithSelector(PrfctOracleErrors.NoBasePrice.selector, usdc));
        oracle.setOracle(eth, uniswapV3Oracle, usdcEthUniswapV3Feed);
    }
