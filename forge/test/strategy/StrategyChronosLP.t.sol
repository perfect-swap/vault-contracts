...
import "../../../contracts/PRFCT/strategies/degens/StrategyChronosLP.sol";
import "../../../contracts/PRFCT/utils/AlgebraUtils.sol";
...
contract StrategyChronosLPTest is BaseStrategyTest {
    ...
    address constant prfct = 0x99C409E5f62E4bd2AC142f17caFb6810B8F0BAAE;
    ...
    function routes() internal pure returns(
        ...
        outputToLp1[1] = ISolidlyRouter.Routes(native, prfct, false);
    }
