...
import "../../../contracts/PRFCT/strategies/Balancer/StrategyAuraGyroMainnet.sol";
import "../../../contracts/PRFCT/strategies/Balancer/PrfctBalancerStructs.sol";
...
contract StrategyAuraGyroTest is Test {
    ...
    function routes() public view returns (
        ...
        PrfctBalancerStructs.BatchSwapStruct[] memory _auraToNativeRoute,
        ...
        _outputToNativeRoute = new PrfctBalancerStructs.BatchSwapStruct[](1);
        _outputToNativeRoute[0] = PrfctBalancerStructs.BatchSwapStruct({
            poolId: 0x5c6ee304399dbdb9c8ef030ab642b10820db8f56000200000000000000000014,
            assetInIndex: 0,
            assetOutIndex: 1
        });

        _nativeToLp0Route = new PrfctBalancerStructs.BatchSwapStruct[](1);
        _nativeToLp0Route[0] = PrfctBalancerStructs.BatchSwapStruct({
            poolId: 0x93d199263632a4ef4bb438f1feb99e57b4b5f0bd0000000000000000000005c2,
            assetInIndex: 0,
            assetOutIndex: 1
        });

        _lp0ToLp1Route = new PrfctBalancerStructs.BatchSwapStruct[](1);
        _lp0ToLp1Route[0] = PrfctBalancerStructs.BatchSwapStruct({
            poolId: 0x93d199263632a4ef4bb438f1feb99e57b4b5f0bd0000000000000000000005c2,
            assetInIndex: 0,
            assetOutIndex: 1
        });

        _auraToNativeRoute = new PrfctBalancerStructs.BatchSwapStruct[](1);
        _auraToNativeRoute[0] = PrfctBalancerStructs.BatchSwapStruct({
    ...
    function setUp() public {
        ...
        StrategyFeeManagerInitializable.CommonAddresses memory commonAddresses = StrategyFeeManagerInitializable.CommonAddresses({
            vault: address(vault),
            unirouter: router,
            keeper: keeper,
            strategist: user,
            prfctFeeRecipient: feeRecipient,
            prfctFeeConfig: feeConfig
        });
