...
import {StratFeeManager, StrategyLLCurveLP} from "contracts/PRFCT/strategies/StakeDAO/StrategyLLCurveLP.sol";
...
contract StrategyLLCurveLPTest is Test {
    ...
    address prfctFeeConfig = 0xDC1dC2abC8775561A6065D0EE27E8fDCa8c4f7ED;
    ...
    function setUp() public {
        ...
        StratFeeManager.CommonAddresses memory commonAddresses = StratFeeManager.CommonAddresses({
            ...
            prfctFeeRecipient: OldStrategy.prfctFeeRecipient(),
            prfctFeeConfig: prfctFeeConfig
        });
