...
contract AddressBookTest is Test {
    ...
    function test_PrfctPlatformConfig_ethereum() external {
        AddressBook.PrfctPlatform memory config = ab.getPrfctPlatformConfig("ethereum");
    ...
    function test_PrfctPlatformConfig_bsc() external {
        AddressBook.PrfctPlatform memory config = ab.getPrfctPlatformConfig("bsc");
