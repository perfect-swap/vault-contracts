...
contract ChainVaultsTest is Test {
    ...
    // address book data
    AddressBook.PrfctPlatform addressBookPrfct;
    ...
    function setUp() public {
        ...
        addressBookPrfct = ab.getPrfctPlatformConfig(chain);
    }
...
//        assertGt(callRewards, 0, "Expected callRewards > 0");
    ...
    function test_panic() external {
        ...
        vm.prank(addressBookPrfct.keeper);
        strategy.panic();
    ...
    function test_correctOwnerAndKeeper() external {
        assertEq(vault.owner(), addressBookPrfct.vaultOwner, "Wrong vault owner.");
        assertEq(strategy.owner(), addressBookPrfct.strategyOwner, "Wrong strategy owner.");
        assertEq(strategy.keeper(), addressBookPrfct.keeper, "Wrong keeper.");
    }
