...
const IRewardRegister = require("../artifacts/contracts/PRFCT/interfaces/binance/IRewardRegister.sol/IRewardRegister.json");
...
const registerSubsidy = async (contract, deployer) => {
  ...
  const appUrl = "https://app.prfct.finance/"
