...
import PrfctOracleAbi from "../../data/abi/PrfctOracle.json";
...
const prfctfinanceOracle = "0x70655508b04cCB34781e557Ad4605D3fe0d98D79";
...
async function setOracle(token, oracle, data) {
  const oracleContract = await ethers.getContractAt(PrfctOracleAbi, prfctfinanceOracle);
