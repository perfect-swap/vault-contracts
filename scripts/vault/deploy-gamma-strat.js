...
import stratAbi from "../../artifacts/contracts/PRFCT/strategies/Gamma/StrategyThenaGamma.sol/StrategyThenaGamma.json";
import stratChefAbi from "../../artifacts/contracts/PRFCT/strategies/Gamma/StrategyQuickGamma.sol/StrategyQuickGamma.json";


const {
  platforms: { quickswap, prfctfinance },
  tokens: {
    ETH: {address: ETH},
    USDC: {address: USDC},
    MATIC: {address: MATIC},
