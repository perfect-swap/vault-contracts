...
import stratAbi from "../../artifacts/contracts/PRFCT/strategies/Balancer/StrategyBalancerMultiRewardGaugeUniV3.sol/StrategyBalancerMultiRewardGaugeUniV3.json";
import stratComAbi from "../../artifacts/contracts/PRFCT/strategies/Balancer/StrategyBalancerComposableMultiRewardGaugeUniV3.sol/StrategyBalancerComposableMultiRewardGaugeUniV3.json";

const {
  platforms: { beethovenX, prfctfinance },
  tokens: {
    BAL: { address: BAL },
...
const strategyParams = {
  ...
  prfctFeeConfig: prfctfinance.prfctFeeConfig,
  isBeets: true,
  prfctVaultProxy: "0xA6D3769faC465FC0415e7E9F16dcdC96B83C240B", //prfctfinance.vaultProxy,
  ...
  outputToNativeAssets: [BAL, OP, ETH],
  outputToNativeRouteBytes: [
    ["0xd6e5824b54f64ce6f1161210bc17eebffc77e031000100000000000000000006", 0, 1],
    ["0x39965c9dab5448482cf7e002f583c812ceb53046000100000000000000000003", 1, 2],
  ],
  nativeToWantAssets: [ETH, wstETH],
  nativeToWantRouteBytes: [["0x7b50775383d3d6f0215a8f290f2c9e2eebbeceb200020000000000000000008b", 0, 1]],
  rewardAssets: [wUSDplus, USDC, wstETH, bbrfETH, ETH],
  rewardRoute: [
...
async function main() {
  ...
  const strategyConstructorArguments = [
    want,
    [strategyParams.isComposable, strategyParams.isBeets],
