...
import stratAbi from "../../artifacts/contracts/PRFCT/strategies/Balancer/StrategyAuraGyroMainnet.sol/StrategyAuraGyroMainnet.json";

const {
  platforms: { balancer, prfctfinance },
  tokens: {
    BAL: { address: BAL },
    ETH: { address: ETH },
    cbETH: { address: cbETH },
...
const strategyParams = {
  ...
  prfctVaultProxy: "0xC551dDCE8e5E657503Cd67A39713c06F2c0d2e97", //prfctfinance.vaultProxy,
