...
async function main() {
  ...
  const PrfctFeeBatchSimple = await ethers.getContractFactory("PrfctFeeBatchSimple");
  const batcher = await PrfctFeeBatchSimple.deploy(config.treasury, config.rewardPool, config.wNative);
