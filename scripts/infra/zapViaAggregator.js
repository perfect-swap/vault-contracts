...
const abi = [
    'function beefIn(address prfctVault, address inputToken, uint256 tokenInAmount, bytes memory token0, bytes memory token1) external',
    ...
    'function quoteRemoveLiquidity(address prfctVault, uint256 mooTokenAmt) external view returns (uint256 amt0, uint256 amt1, address token0, address token1)',
    'function quoteStableAddLiquidityRatio(address prfctVault) external view returns (uint)',
