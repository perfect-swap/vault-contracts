...
const params = {
  prfctMaxiVaultAddress: "0xbF07093ccd6adFC3dEB259C557b61E94c1F66945",
  unirouter: spookyswap.router,
  nativeToNativeRoute: [WFTM, PRFCT],
};
...
const deployStrategistBuyback = async () => {
  ...
  const constructorArguments = [params.prfctMaxiVaultAddress, params.unirouter, params.nativeToNativeRoute];
